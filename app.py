...
def intro():
    ...
    st.markdown(
        ...
        **forecasting** via modelo INLA (Integrated Nested Laplace Approximations)
        ...
        - **Covid-19** — eSUS-Notifica · abas: Descritivo · Testes · Nowcasting + Forecasting
    ...
    with col3:
        if st.button("🧬 Nowcasting + Forecasting — Covid-19", width='stretch'):
...
pg = st.navigation([
    ...
    st.Page("pages/4_eSUS.py", title="Covid-19", icon="🧬"),
